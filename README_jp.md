...
更新履歴: [docs/updates/README.md](docs/updates/README.md) / [beta 1.0.3 日本語](docs/updates/beta-1.0.3.ja.md)
...
| Backend | Auto mode、Awake、通知音と browser notification、Hub / chat の PWA 導線、Gemini direct bridge、任意の public 公開（Cloudflare は実装済み） |
...
- [docs/updates/beta-1.0.3.ja.md](docs/updates/beta-1.0.3.ja.md): `beta 1.0.2` 以降の変更点
